...
FRONTEND_URL = os.environ.get("FRONTEND_URL", "https://quizwizai.netlify.app")

# Gmail SMTP settings (set these as env vars on Render)
...
async def forgot_password(request: ForgotPasswordRequest):
    ...
    try:
        ...
        print(f"ERROR: Failed to send reset email to {request.email}")
